...
class ShipmentValidationReport
{
    ...
    const ERROR_CODE_CHOOSE_EITHER_PP_CARRIER_OR_VENDORS = 'CHOOSE_EITHER_PP_CARRIER_OR_VENDORS';
    const ERROR_CODE_PP_CARRIER_IS_OUT_OF_ALLOWED_COUNTRIES = 'PP_CARRIER_IS_OUT_OF_ALLOWED_COUNTRIES';
    const ERROR_CODE_CHOSEN_COUNTRIES_ARE_NOT_INTERNAL = 'CHOSEN_COUNTRIES_ARE_NOT_INTERNAL';
