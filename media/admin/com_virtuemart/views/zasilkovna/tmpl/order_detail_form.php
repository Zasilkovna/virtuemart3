...
$adultContentChecked = $shipment->getAdultContent() ? 'checked' : '';
...
<div id="packeteryUpdateOrderDetail" class="vm-absolute">
        <form action="index.php?option=com_virtuemart&view=zasilkovna&task=updatePacketeryOrderDetail" method="post" id="packeteryUpdateOrderDetailForm">
            <div>
                <input type="hidden" name="virtuemart_order_id" value="<?php echo($shipment->getVirtuemartOrderId()); ?>">
                <input type="hidden" name="order_number" value="<?php echo($shipment->getOrderNumber()); ?>">
                <?php echo $token; ?>
                <fieldset>
                    <table class="admintable table">
                        ...
                        <tr>
                            ...
                            <td ><input type="number" step="0.1" name="weight" value="<?php echo($shipment->getWeight()); ?>"> kg</td>
                        </tr>
                        <tr>
                            <td class="key va-middle"><?php echo(JText::_('PLG_VMSHIPMENT_PACKETERY_COD')); ?></td>
                            <td>
                                <input type="number" step="0.01" name="packet_cod" value="<?php echo($shipment->getPacketCod()); ?>">
                                <?php echo($shipment->getBranchCurrency()); ?>
                            </td>
                        </tr>
                        <tr>
                            <td class="key va-middle"><?php echo(JText::_('PLG_VMSHIPMENT_PACKETERY_PACKET_PRICE')); ?></td>
                            <td>
                                <input type="number" step="0.01" name="zasilkovna_packet_price" value="<?php echo($shipment->getZasilkovnaPacketPrice()); ?>">
                                <?php echo($shipment->getBranchCurrency()); ?>
                            </td>
                        </tr>
                        <tr>
